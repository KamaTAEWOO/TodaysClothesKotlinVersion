...
## 소개
- 프로젝트는 과거에 만든 프로젝트를 다른 언어를 사용하고 사이에 배운 기술을 복습하기 위해 프로젝트를 진행하였으며, 공공데이터를 활용해 날씨 데이터를 보여주고, 현재 날씨로 인해 입어야 할 옷을 추천해 주는 기능이 있으며, 더 나아가 내가 좋아하는 코디와 내가 가지고 있는 옷을 기록할 수 있는 화면들이 있습니다.
...
- 본인이 가지고 있는 옷을 등록 버튼을 통해 저장
- 저장한 이미지를 클릭 시 큰 이미지로 볼 수 있음
